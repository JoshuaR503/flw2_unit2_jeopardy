...
function attachClickHandlers() {
  $(".question-cell").each((index, questionElement) => {
    ...
    $(questionElement).click(() => questionOnClick(categoryIndex, moneyValue));
  });
}
...
function questionOnClick(categoryIndex, moneyValue) {
  ...
  $("#question-modal-show-answer")
    .click(() => answerOnClick(categoryIndex, moneyValue))
    .show();

  $("#question-modal-close").click(() => hideQuestionPopup());
